...
extern "C"
{
	...
	#[link_name = "\u{1}_ibv_query_pkey"] pub fn ibv_query_pkey(context: *mut ibv_context, port_num: u8, index: c_int, pkey: *mut __be16) -> c_int;
	...
	#[link_name = "\u{1}_ibv_resolve_eth_l2_from_gid"] pub fn ibv_resolve_eth_l2_from_gid(context: *mut ibv_context, attr: *mut ibv_ah_attr, eth_mac: *mut u8, vid: *mut u16) -> c_int;
}
