...
include!("bindgen/constants/ibv_cq_init_attr_mask.rs");
include!("bindgen/constants/ibv_create_cq_attr_flags.rs");
include!("bindgen/constants/ibv_create_cq_wc_flags.rs");
include!("bindgen/constants/ibv_qp_attr_mask.rs");
include!("bindgen/constants/ibv_qp_create_flags.rs");
include!("bindgen/constants/ibv_qp_init_attr_mask.rs");
