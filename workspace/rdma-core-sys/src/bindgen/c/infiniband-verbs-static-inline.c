...
__be32 rust_ibv_wc_read_imm_data(struct ibv_cq_ex * cq)
{
	return ibv_wc_read_imm_data(cq);
}

uint32_t rust_ibv_wc_read_invalidated_rkey(struct ibv_cq_ex * cq)
{
...
unsigned int rust_ibv_wc_read_wc_flags(struct ibv_cq_ex * cq)
{
...
uint64_t rust_ibv_wc_read_completion_wallclock_ns(struct ibv_cq_ex * cq)
{
...
void rust_ibv_wc_read_tm_info(struct ibv_cq_ex * cq, struct ibv_wc_tm_info * tm_info)
{
...
int rust_ibv_modify_cq(struct ibv_cq * cq, struct ibv_modify_cq_attr * attr)
{
...
int rust_ibv_post_srq_ops(struct ibv_srq * srq, struct ibv_ops_wr * op, struct ibv_ops_wr * * bad_op)
{
...
struct ibv_td * rust_ibv_alloc_td(struct ibv_context * context, struct ibv_td_init_attr * init_attr)
{
	return ibv_alloc_td(context, init_attr);
}

int rust_ibv_dealloc_td(struct ibv_td * td)
{
	return ibv_dealloc_td(td);
}

struct ibv_pd * rust_ibv_alloc_parent_domain(struct ibv_context * context, struct ibv_parent_domain_init_attr * attr)
{
...
int rust_ibv_modify_qp_rate_limit(struct ibv_qp * qp, struct ibv_qp_rate_limit_attr * attr)
{
