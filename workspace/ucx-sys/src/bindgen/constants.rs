...
include!("bindgen/constants/UcsCpuSetSize.rs");
include!("bindgen/constants/UctActiveMessageBits.rs");
include!("bindgen/constants/UctCallbackFlags.rs");
include!("bindgen/constants/UctMaximumStringLengths.rs");
include!("bindgen/constants/UctMemoryDomainFlags.rs");
include!("bindgen/constants/UctMemoryDomainMemoryFlags.rs");
include!("bindgen/constants/UctPrivilegeLengths.rs");
